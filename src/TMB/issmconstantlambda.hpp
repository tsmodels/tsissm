/// @file issmconstantlambda.hpp
#ifndef issmconstantlambda_hpp
#define issmconstantlambda_hpp

#undef TMB_OBJECTIVE_PTR
#define TMB_OBJECTIVE_PTR obj

template<class Type>
Type issmconstantlambda(objective_function<Type>* obj) {
    DATA_VECTOR(V);
    DATA_MATRIX(X);
    DATA_VECTOR(good);
    ...
    //vector<Type> transformed_xseed = issmextra::seed_transform(xseed, lambda);
    ...
    states.setZero();
    states.row(0) = init_states.transpose();
